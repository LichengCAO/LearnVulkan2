...
void DescriptorSet::Create(const IDescriptorSetInitializer* inInitPtr)
{
...
void DescriptorSetLayout::Create(const IDescriptorSetLayoutInitializer* inInitialzerPtr)
{
